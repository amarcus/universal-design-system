class UdsRadioGroup extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.addEventListener('uds-change', this._onChange);
        this._updateRadioButtons();
    }

    disconnectedCallback() {
        this.removeEventListener('uds-change', this._onChange);
    }
    ...
    async _render() {
        ...
        linkElem.setAttribute('href', new URL('./uds-radio-group.css' + '?t=' + new Date().getTime(), import.meta.url).href);
        this.shadowRoot.appendChild(linkElem);
        
        try {
            const response = await fetch(new URL('./uds-radio-group.html' + '?t=' + new Date().getTime(), import.meta.url).href);
    ...
    _updateRadioButtons() {
        ...
        radioButtons.forEach(radio => {
            ...
            if (this.hasAttribute('value')) {
                radioButtons.forEach(radio => {
                    if (radio.getAttribute('value') === this.getAttribute('value')) {
